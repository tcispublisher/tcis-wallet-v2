      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              const SizedBox(width: 8),
              _buildHelpCard('Set up your Bitget Wallet', Icons.help_outline),
              const SizedBox(width: 8),
              _buildHelpCard('Buy your first crypto', Icons.support_agent),
              const SizedBox(width: 8),
              _buildHelpCard('Make your first crypto trade', Icons.add_circle),
              const SizedBox(width: 8),
              _buildHelpCard('Basic functions', Icons.access_alarm_sharp),
              const SizedBox(width: 8),
              _buildHelpCard('Swap trading at Bitget', Icons.traffic_rounded),
              const SizedBox(width: 8),
            ],
          ),
        ),
