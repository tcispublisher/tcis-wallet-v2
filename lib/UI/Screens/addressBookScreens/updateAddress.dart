...
class _UpdateAddressState extends State<UpdateAddress> {
  ...
  @override
  void initState() {
    labelController.text="Edric Jaye";
    addressController.text="0x00...001dsax";
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(child: SvgPicture.asset("assets/svgs/mdi_contact-outline (1).svg",height: 60,)),
                    ),
                      ...
                      Row
                        ...
                        children: [
                          Container(
                            ...
                            child: SvgPicture.asset("assets/svgs/mdi_currency-btc.svg",color: headingColor.value,),
                          ),
                          SizedBox(width: 12,),
                          Expanded(
                            child: Text(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            // color: inputFieldBackgroundColor2.value,
                            border: Border.all(width: 1,color: redColor.value)
                        ),
                        child: Row(
