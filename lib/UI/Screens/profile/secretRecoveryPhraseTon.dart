...
class SecretRecoveryPharaseTon extends StatefulWidget {
  SecretRecoveryPharaseTon({super.key});

  @override
  State<SecretRecoveryPharaseTon> createState() => _SecretRecoveryPharaseTonState();
}

class _SecretRecoveryPharaseTonState extends State<SecretRecoveryPharaseTon> {
  ...
  Future<void> _loadWalletData() async {
    ...
    try {
      ...
      String responseMnemonics = await ApiService.getSecret(savedWalletAddress, "TON");
